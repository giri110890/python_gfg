# Python code to demonstrate ceil(), trunc() and floor()
...
print("The value of number till 2 decimal places(using %) is : "
        , end = "")
print("%.2f"%a)
...
# Using round(x,n) :- This function takes 2 arguments, number and the 
